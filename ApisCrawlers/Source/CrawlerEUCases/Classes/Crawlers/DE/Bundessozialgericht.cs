...
namespace Crawler.Classes.Crawlers.DE
{
    ...
    public class Bundessozialgericht : BundesCommon
    {
        public override void Start()
        {
            string startUrl = "http://juris.bundessozialgericht.de/";
            string searchUrl = "/cgi-bin/rechtsprechung/list.py?Gericht=bsg&Art=en&Datum=";
