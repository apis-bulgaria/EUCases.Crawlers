...
namespace ServiceEUCases.Test.Classes
{
    ...
    {
        private ServiceEUCases service;

        public WcfHost(IRepository repository)
        {
            this.service = new ServiceEUCases(repository);
        }

        public string UploadFile(UploadDocumentGroup uploadDocumentGroup)
        {
            return this.service.UploadFile(uploadDocumentGroup);
        }
    }
}
